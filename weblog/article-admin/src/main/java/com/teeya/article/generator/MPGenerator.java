...
public class MPGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("C:\\Users\\周旭\\IdeaProjects\\blog\\weblog\\article-admin\\src\\main\\java");// 生成文件的输出目录
        ...
        dsc.setUrl("jdbc:mysql://129.211.34.120:3306/weblog?characterEncoding=utf8&useSSL=false");// 驱动连接的URL
