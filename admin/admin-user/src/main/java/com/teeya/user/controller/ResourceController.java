...
public class ResourceController {
    ...
    @GetMapping(value = "/{id}")
    public R<ResourceEntity> get(@PathVariable Long id) {
    ...
    @GetMapping
    public R<List<ResourceEntity>> queryListByUserId(@NotNull(message = "用户id不能为空") @RequestParam(value = "userId") Long userId) {
        return R.success(resourceService.queryListByUserId(userId));
    }
    ...
    public R<List<ResourceEntity>> queryListByUsername(@PathVariable String username) {
        return R.success(resourceService.queryListByUsername(username));
    }
    ...
    public R<List<ResourceEntity>> queryListByRoleId(@PathVariable Long roleId) {
        return R.success(resourceService.queryListByRoleId(roleId));
    }
    ...
    public R<IPage> queryList(@RequestBody ResourceQueryForm resourceQueryForm) {
        ...
        return R.success(resourceService.queryList(resourceQueryForm));
    }

    @ApiOperation(value = "获取所有资源集合", notes = "获取所有资源集合")
    @GetMapping("/all")
    public R<List<ResourceEntity>> getAll() {
        return R.success(resourceService.getAll());
    }
