...
public class MPGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("F:\\IdeaProjects\\blog\\demo\\distributed-transaction-rabbitmq-consumer\\src\\main\\java");// 生成文件的输出目录
        ...
        dsc.setUrl("jdbc:mysql://129.211.34.120:3306/distributed-transaction-rabbitmq-consumer?characterEncoding=utf8&useSSL=false");// 驱动连接的URL
